...
from order_control.views import CustomerListView, load_excel, CustomerCreateView, CustomerUpdateView, OrderUpdateView, InstallationUpdateView, order_create, order_delete, customer_delete, order_complete, export_customers, Schedule, PreScheduleView
